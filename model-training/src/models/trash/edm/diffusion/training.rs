...
// impl<B: AutodiffBackend> TrainStep<FrameBatch<B>, RegressionOutput<B>> for Denoiser<B> {
...
// impl<B: Backend> ValidStep<FrameBatch<B>, RegressionOutput<B>> for Denoiser<B> {
