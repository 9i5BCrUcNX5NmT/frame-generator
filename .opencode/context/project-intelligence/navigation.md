<!-- Context: project-intelligence/nav | Priority: high | Version: 2.0 | Updated: 2026-03-16 -->
...
# Also see:
AGENTS.md                     # Build/test commands, code style (root)
```
...
| Quick Start | `AGENTS.md` в корне | Команды сборки, тестов, стиль кода |
